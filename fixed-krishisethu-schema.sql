...
-- Fixed SQL Schema for Supabase/PostgreSQL
-- ==============================
...
-- Insert default categories (using DO block to avoid conflicts)
DO $$
BEGIN
...
-- Insert default brands (using DO block to avoid conflicts)
DO $$
BEGIN
...
-- Insert default settings (using DO block to avoid conflicts)
DO $$
BEGIN
