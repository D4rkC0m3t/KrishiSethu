-- =====================================================
-- ROBUST MULTI-TENANCY FIX
-- Handles existing policies and configurations safely
-- =====================================================
...
-- Delete settings with empty or meaningless values
