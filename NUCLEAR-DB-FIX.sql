-- =====================================================
-- NUCLEAR DATABASE FIX - COMPLETE RESET
...
-- 2. USERS TABLE (backup/compatibility)
CREATE TABLE users (
    id UUID REFERENCES auth.users(id) ON DELETE CASCADE PRIMARY KEY,
    email TEXT,
    full_name TEXT,
...
CREATE POLICY "authenticated_all_access" ON profiles FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON users FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON suppliers FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON categories FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON brands FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON products FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON customers FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON sales FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON sale_items FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON purchases FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON purchase_items FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON stock_movements FOR ALL USING (true);
CREATE POLICY "authenticated_all_access" ON settings FOR ALL USING (true);
...
SELECT 'DATABASE RESET COMPLETE - ALL ISSUES FIXED!' as status;
