-- ============================================================================
-- 🌾 KRISHISETHU INVENTORY MANAGEMENT - QUICK DATABASE SETUP
-- ============================================================================
...
-- ============================================================================
-- ⏱️ TIMESTAMP TRIGGERS (Auto-update updated_at)
-- ============================================================================
...
-- Suppliers
INSERT INTO suppliers (name, contact_person, phone, email, address, gst_number, payment_terms, credit_limit, is_active) VALUES
(
    'Tata Chemicals Ltd',
    'Rajesh Kumar',
    '+91-9876543210',
    'rajesh@tatachemicals.com',
    '{"street": "Tata Centre", "city": "Mumbai", "state": "Maharashtra", "pincode": "400020", "country": "India"}',
    '27AAACT2727Q1ZZ',
    '30 days',
    500000.00,
    true
...
(
    ...
    '+91-9876543211',
    'priya@iffco.coop',
    '{"street": "IFFCO Bhawan", "city": "New Delhi", "state": "Delhi", "pincode": "110001", "country": "India"}',
    '07AAACI1681G1ZN',
    '45 days',
    750000.00,
    true
...
-- Customers
INSERT INTO customers (name, phone, email, address, gst_number, credit_limit, is_active) VALUES
(
    'Raj Farm Enterprises',
    '+91-9876543220',
    'raj@rajfarm.com',
    '{"street": "Village Rajpur", "city": "Rajpur", "state": "Punjab", "pincode": "144001", "country": "India"}',
    '03AABCR1234M1Z5',
    50000.00,
    true
),
(
    ...
    '{"street": "Green Valley Road", "city": "Ludhiana", "state": "Punjab", "pincode": "141001", "country": "India"}',
    '03AABCG5678N2Z6',
    75000.00,
    true
);
