-- ============================================================================
-- FIX PRODUCTS TABLE ACCESS - SPECIFIC RLS POLICIES
-- ============================================================================
...
BEGIN
    ...
    EXECUTE 'CREATE POLICY "categories_select_all" ON public.categories FOR SELECT TO public USING (true)';
    EXECUTE 'CREATE POLICY "categories_insert_authenticated" ON public.categories FOR INSERT TO authenticated WITH CHECK (true)';
    EXECUTE 'CREATE POLICY "categories_update_authenticated" ON public.categories FOR UPDATE TO authenticated USING (true) WITH CHECK (true)';
    EXECUTE 'CREATE POLICY "categories_delete_authenticated" ON public.categories FOR DELETE TO authenticated USING (true)';
...
BEGIN
    ...
    -- Create permissive policies
    EXECUTE 'CREATE POLICY "brands_select_all" ON public.brands FOR SELECT TO public USING (true)';
    EXECUTE 'CREATE POLICY "brands_insert_authenticated" ON public.brands FOR INSERT TO authenticated WITH CHECK (true)';
    EXECUTE 'CREATE POLICY "brands_update_authenticated" ON public.brands FOR UPDATE TO authenticated USING (true) WITH CHECK (true)';
    EXECUTE 'CREATE POLICY "brands_delete_authenticated" ON public.brands FOR DELETE TO authenticated USING (true)';
...
BEGIN
    ...
    -- Create permissive policies
    EXECUTE 'CREATE POLICY "suppliers_select_all" ON public.suppliers FOR SELECT TO public USING (true)';
    EXECUTE 'CREATE POLICY "suppliers_insert_authenticated" ON public.suppliers FOR INSERT TO authenticated WITH CHECK (true)';
    EXECUTE 'CREATE POLICY "suppliers_update_authenticated" ON public.suppliers FOR UPDATE TO authenticated USING (true) WITH CHECK (true)';
    EXECUTE 'CREATE POLICY "suppliers_delete_authenticated" ON public.suppliers FOR DELETE TO authenticated USING (true)';
